...
const DIVISIONS = {
  ...
  W45: { label: "Women O45", short: "WO45" },
  W50: { label: "Women O50", short: "WO50" },
  M45: { label: "Men O45", short: "MO45" },
  M50: { label: "Men O50", short: "MO50" },
  W35I: { label: "Women O35 IMC", short: "W35 IMC" },
};

// M45 plays four round-robin pools (every other division is one pool) —
// standings render one table per pool using this membership map.
const DIVISION_POOLS = {
  M45: {
    A: ["AUS", "ENG", "FRA", "GER", "SCO"],
    B: ["RSA", "MAS", "USA", "SGP", "BEL"],
    C: ["NED", "WAL", "CAN", "EGY", "KEN"],
    D: ["ARG", "IRL", "NZL", "CHI", "ESP"],
  },
};
...
const POOL = [
  ...
  // ==========================================================
  // ROTTERDAM TOURNAMENT — full pool grids (source: Rotterdam
  // Schedule V1, 1-Jul-26). Venues: "ROT Pitch n" = HC Rotterdam,
  // "VIC Pitch X" = HC Victoria.
  // ==========================================================
  // ---- Women O45 (Pool A of 14 · 4 games each) ----
  ["2026-07-23","09:00","W45","AUS","IRL","VIC Pitch A"],
  ["2026-07-23","10:50","W45","URU","ARG","VIC Pitch A"],
  ["2026-07-23","12:40","W45","ENG","RSA","VIC Pitch A"],
  ["2026-07-24","09:00","W45","RSA","SCO","ROT Pitch 1"],
  ["2026-07-24","10:50","W45","WAL","ESP","ROT Pitch 1"],
  ["2026-07-24","12:40","W45","BEL","USA","ROT Pitch 1"],
  ["2026-07-24","14:30","W45","ARG","GER","ROT Pitch 1"],
  ["2026-07-24","16:20","W45","NZL","ENG","ROT Pitch 1"],
  ["2026-07-24","16:35","W45","CHI","AUS","VIC Pitch C"],
  ["2026-07-25","09:00","W45","GER","BEL","VIC Pitch B"],
  ["2026-07-25","10:50","W45","ESP","NZL","VIC Pitch B"],
  ["2026-07-25","12:40","W45","USA","CHI","VIC Pitch B"],
  ["2026-07-25","14:30","W45","IRL","WAL","VIC Pitch B"],
  ["2026-07-25","16:20","W45","SCO","URU","VIC Pitch B"],
  ["2026-07-26","09:00","W45","AUS","USA","VIC Pitch A"],
  ["2026-07-26","09:15","W45","IRL","CHI","VIC Pitch C"],
  ["2026-07-26","10:50","W45","BEL","ARG","VIC Pitch A"],
  ["2026-07-26","12:40","W45","ENG","ESP","VIC Pitch A"],
  ["2026-07-26","14:30","W45","RSA","NZL","VIC Pitch A"],
  ["2026-07-26","16:20","W45","GER","URU","VIC Pitch A"],
  ["2026-07-27","14:30","W45","WAL","AUS","ROT Pitch 2"],
  ["2026-07-27","16:20","W45","ARG","SCO","ROT Pitch 2"],
  ["2026-07-28","09:00","W45","USA","GER","ROT Pitch 2"],
  ["2026-07-28","10:50","W45","NZL","WAL","ROT Pitch 2"],
  ["2026-07-28","12:40","W45","SCO","ENG","ROT Pitch 2"],
  ["2026-07-28","14:30","W45","CHI","BEL","ROT Pitch 2"],
  ["2026-07-28","16:20","W45","ESP","IRL","ROT Pitch 2"],
  ["2026-07-28","18:10","W45","URU","RSA","ROT Pitch 2"],
  // ---- Women O50 (Pool A of 15 · 4 games each) ----
  ["2026-07-23","12:40","W50","ESP","CHI","VIC Pitch B"],
  ["2026-07-23","14:30","W50","ARG","CAN","VIC Pitch A"],
  ["2026-07-23","14:30","W50","ENG","URU","VIC Pitch B"],
  ["2026-07-23","16:20","W50","NED","NZL","VIC Pitch A"],
  ["2026-07-23","16:20","W50","SCO","IRL","VIC Pitch B"],
  ["2026-07-23","18:10","W50","AUS","BEL","VIC Pitch A"],
  ["2026-07-23","18:10","W50","RSA","WAL","VIC Pitch B"],
  ["2026-07-24","09:15","W50","CHI","ENG","VIC Pitch C"],
  ["2026-07-24","11:05","W50","USA","ARG","VIC Pitch C"],
  ["2026-07-24","12:55","W50","NZL","RSA","VIC Pitch C"],
  ["2026-07-24","14:45","W50","IRL","AUS","VIC Pitch C"],
  ["2026-07-25","09:15","W50","WAL","USA","VIC Pitch C"],
  ["2026-07-25","11:05","W50","CAN","SCO","VIC Pitch C"],
  ["2026-07-25","12:55","W50","URU","NED","VIC Pitch C"],
  ["2026-07-25","14:45","W50","BEL","ESP","VIC Pitch C"],
  ["2026-07-26","09:00","W50","ESP","ARG","VIC Pitch B"],
  ["2026-07-26","10:50","W50","NZL","BEL","VIC Pitch B"],
  ["2026-07-26","12:40","W50","NED","AUS","VIC Pitch B"],
  ["2026-07-26","14:30","W50","USA","ENG","VIC Pitch B"],
  ["2026-07-26","16:20","W50","CHI","CAN","VIC Pitch B"],
  ["2026-07-26","18:10","W50","IRL","RSA","VIC Pitch B"],
  ["2026-07-27","09:00","W50","ARG","URU","ROT Pitch 2"],
  ["2026-07-27","10:50","W50","SCO","NZL","ROT Pitch 2"],
  ["2026-07-27","12:40","W50","AUS","WAL","ROT Pitch 2"],
  ["2026-07-28","09:15","W50","WAL","CHI","ROT Pitch 3"],
  ["2026-07-28","11:05","W50","ENG","SCO","ROT Pitch 3"],
  ["2026-07-28","12:55","W50","URU","IRL","ROT Pitch 3"],
  ["2026-07-28","14:45","W50","RSA","ESP","ROT Pitch 3"],
  ["2026-07-28","16:35","W50","BEL","USA","ROT Pitch 3"],
  ["2026-07-28","18:25","W50","CAN","NED","ROT Pitch 3"],
  // ---- Men O45 (Pools A-D of 5 · fully played out) ----
  ["2026-07-23","09:00","M45","ARG","IRL","ROT Pitch 1"],
  ["2026-07-23","10:50","M45","RSA","MAS","ROT Pitch 1"],
  ["2026-07-23","12:40","M45","NED","WAL","ROT Pitch 1"],
  ["2026-07-23","14:30","M45","AUS","ENG","ROT Pitch 1"],
  ["2026-07-24","09:00","M45","GER","AUS","VIC Pitch A"],
  ["2026-07-24","09:00","M45","CAN","NED","VIC Pitch B"],
  ["2026-07-24","10:50","M45","FRA","SCO","VIC Pitch A"],
  ["2026-07-24","10:50","M45","EGY","KEN","VIC Pitch B"],
  ["2026-07-24","12:40","M45","USA","RSA","VIC Pitch A"],
  ["2026-07-24","12:40","M45","NZL","ARG","VIC Pitch B"],
  ["2026-07-24","14:30","M45","SGP","BEL","VIC Pitch A"],
  ["2026-07-24","14:30","M45","CHI","ESP","VIC Pitch B"],
  ["2026-07-25","09:00","M45","ESP","NZL","ROT Pitch 2"],
  ["2026-07-25","09:15","M45","BEL","USA","ROT Pitch 3"],
  ["2026-07-25","10:50","M45","IRL","CHI","ROT Pitch 2"],
  ["2026-07-25","11:05","M45","MAS","SGP","ROT Pitch 3"],
  ["2026-07-25","12:40","M45","KEN","CAN","ROT Pitch 2"],
  ["2026-07-25","12:55","M45","SCO","GER","ROT Pitch 3"],
  ["2026-07-25","14:30","M45","WAL","EGY","ROT Pitch 2"],
  ["2026-07-25","14:45","M45","ENG","FRA","ROT Pitch 3"],
  ["2026-07-26","12:40","M45","AUS","SCO","ROT Pitch 1"],
  ["2026-07-26","12:40","M45","NED","KEN","ROT Pitch 2"],
  ["2026-07-26","14:30","M45","ENG","GER","ROT Pitch 1"],
  ["2026-07-26","14:30","M45","WAL","CAN","ROT Pitch 2"],
  ["2026-07-26","16:20","M45","RSA","BEL","ROT Pitch 1"],
  ["2026-07-26","16:20","M45","ARG","ESP","ROT Pitch 2"],
  ["2026-07-26","18:10","M45","MAS","USA","ROT Pitch 1"],
  ["2026-07-26","18:10","M45","IRL","NZL","ROT Pitch 2"],
  ["2026-07-27","09:15","M45","EGY","NED","ROT Pitch 3"],
  ["2026-07-27","11:05","M45","CHI","ARG","ROT Pitch 3"],
  ["2026-07-27","12:55","M45","SGP","RSA","ROT Pitch 3"],
  ["2026-07-27","14:45","M45","FRA","AUS","ROT Pitch 3"],
  ["2026-07-28","09:00","M45","GER","FRA","VIC Pitch B"],
  ["2026-07-28","09:15","M45","SCO","ENG","VIC Pitch C"],
  ["2026-07-28","10:50","M45","USA","SGP","VIC Pitch B"],
  ["2026-07-28","11:05","M45","BEL","MAS","VIC Pitch C"],
  ["2026-07-28","12:40","M45","CAN","EGY","VIC Pitch B"],
  ["2026-07-28","12:55","M45","KEN","WAL","VIC Pitch C"],
  ["2026-07-28","14:30","M45","NZL","CHI","VIC Pitch B"],
  ["2026-07-28","14:45","M45","ESP","IRL","VIC Pitch C"],
  // ---- Men O50 (Pool A of 22 · 4 games each) ----
  ["2026-07-23","09:00","M50","ARG","JPN","ROT Pitch 2"],
  ["2026-07-23","09:15","M50","CHI","SRI","ROT Pitch 3"],
  ["2026-07-23","10:50","M50","NED","NZL","ROT Pitch 2"],
  ["2026-07-23","12:40","M50","SCO","ENG","ROT Pitch 2"],
  ["2026-07-23","14:30","M50","RSA","BAN","ROT Pitch 2"],
  ["2026-07-23","16:20","M50","GER","WAL","ROT Pitch 1"],
  ["2026-07-23","16:20","M50","MAS","KEN","ROT Pitch 2"],
  ["2026-07-23","18:10","M50","HKG","AUS","ROT Pitch 1"],
  ["2026-07-23","18:10","M50","FRA","ESP","ROT Pitch 2"],
  ["2026-07-24","09:15","M50","IRL","SGP","ROT Pitch 3"],
  ["2026-07-24","11:05","M50","ENG","RSA","ROT Pitch 3"],
  ["2026-07-24","12:55","M50","NZL","MAS","ROT Pitch 3"],
  ["2026-07-24","14:45","M50","WAL","USA","ROT Pitch 3"],
  ["2026-07-24","16:20","M50","BEL","HKG","VIC Pitch B"],
  ["2026-07-24","16:35","M50","KEN","FRA","VIC Pitch C"],
  ["2026-07-25","09:00","M50","SGP","GER","VIC Pitch A"],
  ["2026-07-25","10:50","M50","SRI","SCO","VIC Pitch A"],
  ["2026-07-25","12:40","M50","ESP","ARG","VIC Pitch A"],
  ["2026-07-25","14:30","M50","BAN","IRL","VIC Pitch A"],
  ["2026-07-25","16:20","M50","USA","NED","VIC Pitch A"],
  ["2026-07-25","18:10","M50","JPN","BEL","VIC Pitch A"],
  ["2026-07-25","18:10","M50","AUS","CHI","VIC Pitch B"],
  ["2026-07-26","09:00","M50","GER","IRL","ROT Pitch 2"],
  ["2026-07-26","09:15","M50","ARG","FRA","ROT Pitch 3"],
  ["2026-07-26","10:50","M50","BAN","ENG","ROT Pitch 2"],
  ["2026-07-26","11:05","M50","KEN","NZL","ROT Pitch 3"],
  ["2026-07-26","12:55","M50","RSA","SCO","ROT Pitch 3"],
  ["2026-07-26","14:45","M50","SRI","AUS","ROT Pitch 3"],
  ["2026-07-26","16:35","M50","MAS","NED","ROT Pitch 3"],
  ["2026-07-27","09:00","M50","NZL","USA","VIC Pitch B"],
  ["2026-07-27","09:15","M50","ESP","KEN","VIC Pitch C"],
  ["2026-07-27","10:50","M50","BEL","ARG","VIC Pitch B"],
  ["2026-07-27","11:05","M50","SCO","CHI","VIC Pitch C"],
  ["2026-07-27","12:40","M50","IRL","RSA","VIC Pitch B"],
  ["2026-07-27","12:55","M50","SGP","BAN","VIC Pitch C"],
  ["2026-07-27","14:30","M50","ENG","SRI","VIC Pitch B"],
  ["2026-07-27","14:45","M50","NED","WAL","VIC Pitch C"],
  ["2026-07-27","16:20","M50","FRA","MAS","VIC Pitch B"],
  ["2026-07-27","16:35","M50","HKG","JPN","VIC Pitch C"],
  ["2026-07-28","16:20","M50","AUS","BEL","VIC Pitch B"],
  ["2026-07-28","16:35","M50","CHI","HKG","VIC Pitch C"],
  ["2026-07-28","18:10","M50","USA","GER","VIC Pitch A"],
  ["2026-07-28","18:10","M50","JPN","ESP","VIC Pitch B"],
  ["2026-07-28","18:25","M50","WAL","SGP","VIC Pitch C"],
  // ---- Women O35 IMC (combined 35/40 IMC pool of 6 · 5 games each) ----
  ["2026-07-23","14:45","W35I","AUSB35","ALLP40","ROT Pitch 3"],
  ["2026-07-23","16:35","W35I","ALL35","USA","ROT Pitch 3"],
  ["2026-07-23","18:25","W35I","ALLB40","ARGB40","ROT Pitch 3"],
  ["2026-07-25","09:00","W35I","USA","ALLP40","ROT Pitch 1"],
  ["2026-07-25","10:50","W35I","ARGB40","ALL35","ROT Pitch 1"],
  ["2026-07-25","12:40","W35I","AUSB35","ALLB40","ROT Pitch 1"],
  ["2026-07-27","12:40","W35I","ALLP40","ALLB40","VIC Pitch A"],
  ["2026-07-27","14:30","W35I","ARGB40","USA","VIC Pitch A"],
  ["2026-07-27","16:20","W35I","ALL35","AUSB35","VIC Pitch A"],
  ["2026-07-28","12:40","W35I","USA","AUSB35","VIC Pitch A"],
  ["2026-07-28","14:30","W35I","ALLB40","ALL35","VIC Pitch A"],
  ["2026-07-28","16:20","W35I","ALLP40","ARGB40","VIC Pitch A"],
  ["2026-07-30","09:00","W35I","AUSB35","ARGB40","ROT Pitch 2"],
  ["2026-07-30","11:00","W35I","ALL35","ALLP40","ROT Pitch 2"],
...
const FINAL_RANKS = { W35: {}, W40: {}, M35: {}, M40: {}, W45: {}, W50: {}, M45: {}, M50: {}, W35I: {} };
...
const KNOCKOUT = [
  ...
  { d:"2026-07-29", t:"13:00", div:"W35", label:"Quarterfinal 3 · 2nd vs 7th of Pool A", p:5, ranks:[2,7], teams:["NZL","USA"] },
  ...
  { d:"2026-07-31", t:"08:00", div:"W35", label:"Class 7/8 · QF runners-up 3 vs 4", p:5, ranks:R(1,8), teams:["USA","SCO"] },
