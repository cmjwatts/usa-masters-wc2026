...
const ROSTERS = {
  ...
  W35: {
    ...
    players: [
      { name: "Missy Arenz", number: null, position: "Defense", college: "University of Delaware", hometown: "Fredericksburg, VA → Landenberg, PA", fact: "All-CAA defender at Delaware (as Missy Woodie), then coached on the Blue Hens' staff that won the 2016 national championship.", photo: "", quote: "Somewhere behind the athlete you've become… is a little girl who fell in love with the game and never looked back… play for her. — Mia Hamm" },
      { name: "Emma Beck", number: 0, position: "Goalkeeper", college: null, hometown: "Lewisberry, PA → Baltimore, MD", fact: null, photo: "", quote: "Don't think too hard and just do it." },
      ...
      { name: "Katie Braun", number: 22, position: "Midfield/Defense", college: null, hometown: "Pittsburgh, PA", fact: "U.S. Masters veteran — 2022 World Cup in Nottingham, and pulling double duty on the 2026 indoor AND outdoor World Cup teams.", photo: "", quote: null },
      ...
      { name: "Katharina Helling", number: 44, position: "Defense/Midfield", college: "University at Albany", hometown: "Philadelphia, PA", fact: "First Team All-America East at UAlbany, after a club career spanning Mannheim, Melbourne, Prague and Hong Kong.", photo: "", quote: "Be a gold fish" },
      ...
      { name: "Melissa Katz", number: 33, position: "Goalkeeper", college: "Monmouth University", hometown: "Tinton Falls, NJ → Atlanta, GA", fact: "Four-year starter in goal at Monmouth (60 starts, All-NEC) — now training the next generation of Atlanta goalkeepers.", photo: "", quote: "Nothing is impossible" },
      { name: "Amy Krompinger", number: 3, position: "Forward", college: "University of Connecticut", hometown: "Wilmington, DE → Sandy Hook, CT", fact: "NCAA Final Four defender at UConn who now runs AIM Athletes FH Club — and won silver with USA O-35 at the Pan Am Continental Cup.", photo: "", quote: "If you're not having fun, why do it?" },
      ...
      { name: "Melissa \"Mel\" McCarthy", number: 6, position: "Forward/Midfield", college: "Hofstra University", hometown: "Havertown, PA", fact: "All-America Rookie at Millersville, CAA Scholar-Athlete of the Year at Hofstra, now head coach at Widener — on BOTH the 2026 indoor and outdoor World Cup teams.", photo: "", quote: "Score more than you get scored on" },
      { name: "Nicole Morgan", number: null, position: "Forward/Midfield", college: "Appalachian State", hometown: "Virginia Beach, VA", fact: "NorPac Offensive Player of the Year at App State and top-10 in program history in career points — with years of USA Masters coaching on top.", photo: "", quote: null },
      { name: "Hillary Paul Metcalf", number: 2, position: "Forward/Midfield", college: "Stevens Institute of Technology", hometown: "Concord, NH → Chelsea, MA", fact: "Anchored the back line for the Stevens Ducks in Hoboken.", photo: "", quote: null },
      ...
      { name: "Erin Tarburton", number: 13, position: "Defense/Midfield", college: "University of Delaware", hometown: "San Diego, CA → New Castle, DE", fact: "Delaware forward (as Erin Marihugh), U.S. U-16 alum and U.S. Indoor National Teamer.", photo: "", quote: "You miss 100% of the shots you don't take. — Wayne Gretzky" },
      { name: "Courtney Veinotte Crosby", number: 12, position: "Midfield", college: "University of Maine", hometown: "Skowhegan, ME → Georgetown, ME", fact: "Four-year Black Bear and senior captain, former Hofstra head coach — and just rejoined Maine's coaching staff this spring.", photo: "", quote: null },
      { name: "Maria Vergara", number: null, position: null, college: null, hometown: "Hyattsville, MD", fact: null, photo: "", quote: null },
      { name: "Christine Watts", number: null, position: "Defense", college: "William & Mary", hometown: "Williamsburg, VA → Atlanta, GA", fact: "Four-year Tribe defender who started every match as a junior, three-time NFHCA All-Academic pick — and now President of the Georgia Field Hockey Association.", photo: "assets/action-point.jpg", quote: null },
      { name: "Alesha Widdall", number: null, position: "Goalkeeper", college: "UMass Amherst", hometown: "Whitney Point, NY", fact: "Two-time All-American in goal at UMass, 57 caps for the U.S. National Team, and a 2016 Rio Olympian.", photo: "", quote: null },
    ],
  },
