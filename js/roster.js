...
const ROSTERS = {
  ...
  W35I: {
    ...
    players: [
      ...
      { name: "Heather Kenney", number: 12, position: "Forward", college: null, hometown: "Rockville, MD", fact: "A 2002 Third Team All-American and bronze medalist at the 2023 Maccabi Pan American Games \u2014 now a biologist and head JV coach at Stone Ridge School of the Sacred Heart, making her IMC debut in Rotterdam.", photo: "assets/players/heather-kenney.jpg", quote: null },
      { name: "Meshia Begin", number: 14, position: "Midfield", college: null, hometown: "Northampton, MA", fact: "Head varsity coach of the Northampton High Blue Devils — and she runs the city's summer youth field hockey program, growing the game at home between USA call-ups.", photo: "assets/players/meshia-begin.jpg", quote: null },
      ...
      { name: "Kerri Kinsella", number: 19, position: "Defense", college: "Westfield State University", hometown: "Seekonk, MA", fact: "Played back for the Westfield State Owls \u2014 and now coaches the 7/8s alongside USA teammate Patricia Zini for the Norfolk Recreation Department.", photo: "assets/players/kerri-kinsella.jpg", quote: null },
